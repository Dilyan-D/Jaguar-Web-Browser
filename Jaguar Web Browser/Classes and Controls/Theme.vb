...
Class Theme
    ...
    Protected Overrides Sub PaintHook()
        G.Clear(Border)
        G.FillRectangle(New SolidBrush(BackColor), New Rectangle(4, 26, Width - 8, Height - 30))
        'G.DrawString(FindForm.Text, Font, TextBrush, New Point(10, 5))
