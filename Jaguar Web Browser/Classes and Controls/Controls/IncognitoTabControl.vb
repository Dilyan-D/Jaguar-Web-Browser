...
Public Class IncognitoTabControl
    ...
    Public Sub New()
        ...
        Me.TitleHeight = 27
        Me.VIBlendTheme = OFFICE2010BLACK
    ...
    Sub NewTab()
        ...
        Dim IncognitoWebBrowser As New EO.WinForm.WebControl
        IncognitoWebBrowser.Dock = DockStyle.Fill
        TabPage.Controls.Add(IncognitoWebBrowser)

        Dim IncognitoWebView As New WebView
        IncognitoWebBrowser.WebView = IncognitoWebView

        AddHandler IncognitoWebView.LoadCompleted, AddressOf IncognitoWebView_LoadComplated
        AddHandler IncognitoWebView.UrlChanged, AddressOf IncognitoWebView_UrlChangedComplated
        AddHandler IncognitoWebView.NewWindow, AddressOf IncognitoWebView_NewWindow
        AddHandler IncognitoWebView.BeforeContextMenu, AddressOf IncognitoWebView_BeforeContextMenu
    End Sub
    ...
    Private Sub IncognitoWebView_LoadComplated(ByVal sender As Object, ByVal e As LoadCompletedEventArgs)
        Try
    ...
    Private Sub IncognitoWebView_UrlChangedComplated(ByVal sender As Object, ByVal e As EventArgs)
        Try
            Me.SelectedTab.Text = CType(Me.SelectedTab.Controls.Item(0), EO.WinForm.WebControl).WebView.Title.ToString
    ...
    Private Sub IncognitoWebView_NewWindow(ByVal sender As Object, ByVal e As NewWindowEventArgs)
        NewTab()
    End Sub

    Private Sub IncognitoWebView_BeforeContextMenu(sender As Object, e As BeforeContextMenuEventArgs)
